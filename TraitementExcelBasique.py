...
def traitementDonneesBasiques(fileExcel,listeFeuilles):
    print("départ")
    for feuilleNum in listeFeuilles:
        data = pd.read_excel(fileExcel,"N°"+str(feuilleNum))
...
traitementDonneesBasiques("outputBasique3.xlsx",[1,2,3,4,5])
