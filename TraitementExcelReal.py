...
excelName = "outputTest.xlsx"
numeroMelanges = [1]

traitementDonneesReelles(excelName,numeroMelanges)
#traitementDonneesReelles(excelName, numeroMelanges, mixtures_dict, column_nucleotypes_dict)
